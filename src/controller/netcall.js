import NetcallWeixin from '../vendors/NIM_Web_Netcall_weixin_v6.7.0.js'
...
export default class NetcallController {
  constructor(props) {
    console.log("inital netcall controller");
    NIM.use(NetcallWeixin)
    NetcallWeixin.destroy()
    props.appkey = app.globalData.ENVIRONMENT_CONFIG.appkey;
