...
/* 1 */
/*!**********************************************************************************************************!*\
  !*** ./node_modules/_@dcloudio_uni-mp-weixin@2.0.0-24220191115011@@dcloudio/uni-mp-weixin/dist/index.js ***!
  \**********************************************************************************************************/
...
/* 2 */
/*!*********************************************************************************************************************************************!*\
  !*** ./node_modules/_@dcloudio_vue-cli-plugin-uni@2.0.0-24220191115011@@dcloudio/vue-cli-plugin-uni/packages/mp-vue/dist/mp.runtime.esm.js ***!
  \*********************************************************************************************************************************************/
...
/* 5 */
/*!************************************************************************************************!*\
  !*** ./node_modules/_@dcloudio_uni-stat@2.0.0-24220191115011@@dcloudio/uni-stat/dist/index.js ***!
  \************************************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 6 */
/*!***********************************************************************************************!*\
  !*** ./node_modules/_@dcloudio_uni-stat@2.0.0-24220191115011@@dcloudio/uni-stat/package.json ***!
  \***********************************************************************************************/
...
module.exports = JSON.parse("{\"name\":\"@dcloudio/uni-stat\",\"version\":\"2.0.0-24220191115011\",\"description\":\"\",\"main\":\"dist/index.js\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/dcloudio/uni-app.git\",\"directory\":\"packages/uni-stat\"},\"scripts\":{\"dev\":\"NODE_ENV=development rollup -w -c rollup.config.js\",\"build\":\"NODE_ENV=production rollup -c rollup.config.js\"},\"files\":[\"dist\",\"package.json\",\"LICENSE\"],\"author\":\"\",\"license\":\"Apache-2.0\",\"devDependencies\":{\"@babel/core\":\"^7.5.5\",\"@babel/preset-env\":\"^7.5.5\",\"eslint\":\"^6.1.0\",\"rollup\":\"^1.19.3\",\"rollup-plugin-babel\":\"^4.3.3\",\"rollup-plugin-clear\":\"^2.0.7\",\"rollup-plugin-commonjs\":\"^10.0.2\",\"rollup-plugin-copy\":\"^3.1.0\",\"rollup-plugin-eslint\":\"^7.0.0\",\"rollup-plugin-json\":\"^4.0.0\",\"rollup-plugin-node-resolve\":\"^5.2.0\",\"rollup-plugin-replace\":\"^2.2.0\",\"rollup-plugin-uglify\":\"^6.0.2\"},\"gitHead\":\"468c99a56198f65946b88ec2f6a6462ed3a7dee6\",\"__npminstall_done\":\"Tue Dec 31 2019 10:21:51 GMT+0800 (GMT+08:00)\",\"_from\":\"@dcloudio/uni-stat@2.0.0-24220191115011\",\"_resolved\":\"https://registry.npm.taobao.org/@dcloudio/uni-stat/download/@dcloudio/uni-stat-2.0.0-24220191115011.tgz\"}");
...
var _default = {
  "pages": {
    ...
    "pages/mine/index": {
      "navigationBarTitleText": "Hina闪推侠"
    },
    "pages/mine/info": {
      "navigationBarTitleText": "Hina闪推侠"
    },
    ...
    "pages/uploadCv/recommender": {
      "navigationBarTitleText": "邮箱上传简历"
    },
    "pages/uploadCv/candidate": {
      "navigationBarTitleText": "邮箱上传简历"
    },
    "pages/uploadCv/success": {
      "navigationBarTitleText": "邮箱上传简历"
    },
    "pages/share/index": {
      "navigationBarTitleText": "推荐信息"
    },
    "pages/post/index": {}
  },
  "globalStyle": {
...
var logitems = [];
var dbgRtmp = false;
var systemInfoChecked = false;
var uid = "".concat(parseInt(Math.random() * 1000000));
var timer;
...
var requestPermission = function requestPermission(scope, cb) {
  wx.getSetting({
...
var log = function log(msg, level) {
  var time = formatTime(new Date());
  logitems.push("".concat(time, ": ").concat(msg));

  if (level === "error") {
    console.error("".concat(time, ": ").concat(msg));
  } else {
    console.log("".concat(time, ": ").concat(msg));
  }
};
...
var mashupUrl = function mashupUrl(url, channel) {
  return url;
};
...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(duration) {
...
var checkSystemInfo = function checkSystemInfo(app) {
  if (!systemInfoChecked) {
    systemInfoChecked = true;
    wx.getSystemInfo({
      success: function success(res) {
        log("".concat(JSON.stringify(res)));
        var sdkVersion = res.SDKVersion;
        var version_items = sdkVersion.split(".");
        var major_version = parseInt(version_items[0]);
        var minor_version = parseInt(version_items[1]);
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setAuthorization: function setAuthorization(state, status) {
      state.authorization = status;
    },
    setRegister: function setRegister(state, status) {
      state.register = status;
    },
    setToken: function setToken(state, token) {
      state.token = token;
    },
    setInfoChange: function setInfoChange(state) {
